...
public class FusionTableSample {
     ...
     */
    private static final String APPLICATION_NAME = "TestTable";
    ...
    public static void main(String[] args) {
        try {
            ...
            String tableId = getTableId("TestTable"); //make sure to use exact spelling for this method
