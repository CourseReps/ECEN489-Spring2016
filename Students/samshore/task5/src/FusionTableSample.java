...
public class FusionTableSample {
     ...
     */
    private static final String APPLICATION_NAME = "Task 5";
    ...
    private static Credential authorize() throws Exception {
        ...
        GoogleClientSecrets clientSecrets = GoogleClientSecrets.load(
                JSON_FACTORY, new InputStreamReader(
                        FusionTableSample.class.getResourceAsStream("client_secret_983247781128-brbggaldg41puh23anr3useeqhj3s7u4.apps.googleusercontent.com.json")));
    ...
    private static void showRows(String tableId) throws IOException {
        ...
        Sql sql = fusiontables.query().sql("SELECT 'Text Column','Number Column','Image Column' FROM " + tableId);
    ...
    private static void newRow(String tableId) throws IOException{
        View.header("Updating Table");

        Sql sql = fusiontables.query().sql("INSERT INTO " + tableId + " ('Text Column','Number Column','Image Column') "
                + "VALUES (" + "'Row 3', " + "3, " + "'http://connective.skapaflex.com/wp-content/uploads/three.png')");
