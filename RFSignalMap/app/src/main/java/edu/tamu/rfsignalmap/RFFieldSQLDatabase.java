    ...
    public boolean AddNewEntry(RFData RFMember)
    {
        ...
        try                                                             /// Try to get JSON, and save data to database
        {
            if (RFMember.XbeeID != -1)                                  /// If not default then save data
            {
                ...
                sql_string += "intAntState,";                           /// Field: intAntState
                ...
                sql_string += "fltLatitudeVN,";                         /// Field: fltLatitude VectorNav
                sql_string += "fltLongitudeVN,";                        /// Field: fltLongitude VectorNav
                sql_string += "fltYawVN,";                              /// Field: fltYaw VectorNav
                sql_string += "fltPitchVN,";                            /// Field: fltPitch VectorNav
                sql_string += "fltRollVN,";                             /// Field: fltRoll VectorNav
                ...
                sql_string += RFMember.RFAntennaState + ",";            /// Value: RF Antenna State
                ...
                sql_string += RFMember.VecNav_Latitude + ",";           /// Value: Latitude VectorNav
                sql_string += RFMember.VecNav_Longitude + ",";          /// Value: Longitude VectorNav
                sql_string += RFMember.VecNav_Yaw + ",";                /// Value: Yaw VectorNav
                sql_string += RFMember.VecNav_Pitch + ",";              /// Value: Pitch VectorNav
                sql_string += RFMember.VecNav_Roll + ",";               /// Value: Roll VectorNav
            ...
            {
                System.err.println("AddNewEntry: Invalid XBee ID");     /// Print the exception data and exit
    ...
    public ArrayList ListDataByGeoArea(float StartLatitude, float StartLongitude, float EndLatitude, float EndLongitude)
    {
        ...
        try
        {
            ...
            if ((StartLatitude != 0) | (StartLongitude != 0) | (EndLatitude != 0) | (EndLongitude != 0))
            {
                ...
                sql_string += "dtSampleDate >= '2017-02-20' AND ";          /// Data Field
